...
namespace AppMetrics.Grpc.AspNetCore
{
    ...
    {
        /// <summary>
        /// Adds App Metrics Grpc middleware to the Microsoft.AspNetCore.Hosting.IWebHostBuilder.
        /// </summary>
        /// <param name="hostBuilder">The Microsoft.AspNetCore.Hosting.IWebHostBuilder.</param>
        /// <returns> A reference to this instance after the operation has completed.</returns>
        public static IWebHostBuilder UseGrpcMetrics(this IWebHostBuilder hostBuilder)
        {
